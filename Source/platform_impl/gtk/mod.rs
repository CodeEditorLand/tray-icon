...
use crate::{icon::Icon, TrayIconAttributes, TrayIconId, COUNTER};
...
impl TrayIcon {
	...
	pub fn set_icon(&mut self, icon:Option<Icon>) -> crate::Result<()> {
		...
		self.indicator.set_icon_theme_path(&parent_path.to_string_lossy());
		self.indicator.set_icon_full(&icon_path.to_string_lossy(), "tray icon");
		self.path = icon_path;
	...
	pub fn rect(&self) -> Option<crate::Rect> { None }
}
